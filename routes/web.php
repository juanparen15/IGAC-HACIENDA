...
Route::get('/consulta-predial', [PredialController::class, 'consultar'])->name('consulta.predial');

Route::get('/buscar-predios', [PredialController::class, 'buscar'])->name('buscar.predios');

Route::post('/predio/like', [PredialController::class, 'likePredio'])->name('predio.like');

Route::post('/predio/rate', [PredialController::class, 'rate'])->name('predio.rate');

Route::post('/predio/view', [PredialController::class, 'addView'])->name('predio.view');
