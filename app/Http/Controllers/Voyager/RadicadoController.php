...
class RadicadoController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeRadicados = Voyager::model('DataType')->where('slug', '=', 'igac-radicado')->first();
        $dataTypeSolicitudes = Voyager::model('DataType')->where('slug', '=', 'igac-solicitud')->first();
        // $dataTypeSolicitudes = Voyager::model('DataType')->where('slug', 'igac-solicitud')->firstOrFail();
        ...
        $solicitudess = app($dataTypeSolicitudes->model_name)->currentUser()->get(); // Filtrar por usuario autenticado
