            ...
            <div class="login-container">
                ...
                <x-guest-layout>
                    <x-authentication-card>
                        <x-validation-errors class="mb-12" />
                        <div class="mb-4 font-medium text-sm text-red-600">
                            <h3>IMPORTANTE: </h3>
                            Su reclamo será redireccionado al IGAC quienes son responsables del mismo.
                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-2">
                                                {!! __('Acepto los :terms_of_service', [
                                                    'terms_of_service' =>
                                                        '<a target="_blank" href="https://www.puertoboyaca-boyaca.gov.co/Paginas/Politicas-de-Privacidad-y-Condiciones-de-Uso.aspx" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">' .
